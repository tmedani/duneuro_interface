inline void print_help_msg()
{
    std::printf("\n    ");
    std::printf("\n    BST_DUNEURO.EXE");
    std::printf("\n    This script computes lead fields for EEG-MEG forward problem.");
    std::printf("\n    Based on duneuro toolbox (www.duneuro.org)");
    ...
    std::printf("\n    ");
    std::printf("\n    Usage: bst_duneuro config_file.ini --mode");
    std::printf("\n    ");
    std::printf("\n        - config_file.ini");
    ...
    std::printf("\n        - mode: {eeg, meg}");
    std::printf("\n    ");
    std::printf("\n    The application computes the transfer matrix and the final leadfields discretization solution.");
    std::printf("\n    If the source space model is modified, the application will search for a previously computed transfer");
    ...
    std::printf("\n    ");
    std::printf("\n        - bst_duneuro eeg_transfer_cg_0001.ini --eeg             Will compute solution for eeg.");
    std::printf("\n    ");
    std::printf("\n        - bst_duneuro meg_transfer_dg_0005.ini --meg             Will compute solution for meg.");
    //std::printf("\n    ");
    //std::printf("\n        - bst_duneuro meg_transfer_dg_0005.ini --eeg_and_meg     Will compute solution for both eeg and meg.");
    std::printf("\n    ");
    std::printf("\n    ");
    std::printf("\n=============================================================================");
